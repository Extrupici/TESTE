            ...
            try {
                ...
                if (requiredXp <= level.getLevelingXp(sender.id, _level)) {
                    ...
                    if (5 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'GAY I', _level)
                        ...
                        level.addLevelingRole(sender.id, 'GAY II', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (15 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'GAY III', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (20 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLA I', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (25 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLA II', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (30 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLA III', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (35 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLAGEM NIVEL DO RUDI I', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (40 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLAGEM NIVEL DO RUDI II', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
                    } else if (45 <= level.getLevelingLevel(sender.id, _level)) {
                        level.addLevelingRole(sender.id, 'BOIOLAGEM N�VEL DO RUDI III', _level)
                        await dxxoo.reply(from, `*「 LEVEL UP 」*\n\n➸ *Name*: ${pushname}\n➸ *XP*: ${level.getLevelingXp(sender.id, _level)} / ${fetchXp}\n➸ *Level*: ${getLevel} -> ${level.getLevelingLevel(sender.id, _level)} 🆙\n➸ *Role*: ${getRole} -> ${level.getLevelingRole(sender.id, _level)} 🆙\nCongrats!! 🎉🎉`, id)
...
Untuk menggunakan bot silahkan kirim ${prefix}menu`)
            ...
            break
            case 'level':
                if (!isReg) return await dxxoo.reply(from, 'Voce n�o est� registrado porra !!!', id)
                if (!isLevelingOn) return dxxoo.reply(from, `Fitur Level Belum di Aktifkan\n\nSilahkan ketik ${prefix}leveling`, id)
                if (!isGroupMsg) return await dxxoo.reply(from, 'Os recursos so podem ser usados em grupos', id)
                const getUserRole = level.getLevelingRole(sender.id, _level)
                const userLevel = level.getLevelingLevel(sender.id, _level)
                const userXp = level.getLevelingXp(sender.id, _level)
                if (userLevel === undefined && userXp === undefined) return await dxxoo.reply(from, 'Voc� ainda n�o tem um n�vel !', id)
            ...
            break
            case 'Entre os Melhores':
                if (!isReg) return await dxxoo.reply(from, 'Voc� n�o est� registrado!!!', id)
                if (!isLevelingOn) return dxxoo.reply(from, `Fitur Level Belum di Aktifkan\n\nSilahkan ketik ${prefix}leveling`, id)
                if (!isGroupMsg) return await dxxoo.reply(from, 'Recursos so podem ser usados em grupos', id)
                ...
                try {
                    ...
                    console.error(err)
                    await dxxoo.reply(from, 'Requer pelo menos * 10 * usu�rios de banco de dados de n�vel!', id)
                }
            break
            case 'setbackground':
            case 'setbg':
                ...
                if (levels === undefined && xps === undefined) return await dxxoo.reply(from, 'Voc� ainda n�o tem um n�vel!!', id)
                card.replaceBg(sender.id, url, _bg)
                await dxxoo.reply(from, 'sucesso definiu um novo plano de fundo!', id)
            break
            case 'leveling':
                if (!isReg) return await dxxoo.reply(from, 'Voc� n�o est� registrado!!!!', id)
                if (!isGroupMsg) return await dxxoo.reply(from, 'Recursos so podem ser usados em grupos', id)
                if (!isGroupAdmins) return await dxxoo.reply(from, 'Recurso so pode ser acessado por um ADM', id)
                if (args[0] === 'on') {
                    if (isLevelingOn) return await dxxoo.reply(from, 'O recurso de nivel j� foi ativado antes.', id)
                    _leveling.push(groupId)
                    fs.writeFileSync('./lib/data/function/group/leveling.json', JSON.stringify(_leveling))
                    await dxxoo.reply(from, 'Recurso de nivel ativado com sucesso * ativado *!', id)
                } else if (args[0] === 'off') {
	...
	//Sticker Converter
       ...
       case 'emojisticker':
            ...
            dxxoo.sendStickerfromUrl(from, `https://api.vhtear.com/emojitopng?code=${emoji}&apikey=${vhtearkey}`)
             .catch ((err) => {
                console.log(err)
                dxxoo.reply(from, 'Desculpe, o emoji que voc� enviou n�o � compat�vel com adesivos, tente outros emojis '', id)
                dxxoo.sendText(ownerNumber, 'Parece que o emojisticker est� errado: ' + err);
            })
            break
	case 'stikertoimg':
	case 'stickertoimg':
	case 'stimg':
            if (quotedMsg && quotedMsg.type == 'sticker') {
                ...
                await dxxoo.sendFile(from, imageBase64, 'imgsticker.jpg', 'Berhasil converter etiqueta em imagem!', id)
                .then(() => {
                ...
                try {
                    if (isMedia && isImage) {
                        ...
                        canvas.Canvas.jail(ppRaw)
                            .then(async (buffer) => {
                                canvas.write(buffer, `${sender.id}_hitlered.jpg`)
                                await dxxoo.sendFile(from, `${sender.id}_hitlered.jpg`, `${sender.id}_hitlered.jpg`, 'Pronto, se voc� deseja fotos de pessoas que querem estar na pris�o, envie um link para foto / imagem com a legenda #Penjara ', id)
                                fs.unlinkSync(`${sender.id}_hitlered.jpg`)
                            })
                    }
                } catch (err) {
                      ...
                      if (isMedia && isImage) {
                        ...
                        canvas.Canvas.kiss(ppFirst, ppSecond)
                            .then(async (buffer) => {
                                ...
                                await dxxoo.sendFile(from, `${sender.id}_kiss.png`, `${sender.id}_kiss.png`, 'Pronto, se voc� quiser uma foto da pessoa que deseja beijar, envie uma foto com a legenda #kiss', id)
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Mascot Giming\nPemakaian: ${prefix}mascotlogo [teks]\n\ncontoh: ${prefix}mascotlogo Dimas`, id)
                ...
                await dxxoo.sendFileFromUrl(from, `https://api.vhtear.com/gamelogo?text=${lmascotlogo}&apikey=${vhtearkey}`, '', 'Nih...', id)
                    .then(() => console.log('Successo imagem criada!'))
                    .catch(async (err) => {
                        console.error(err)
                        await dxxoo.reply(from, `Error!`, id)
                    })
    ...
    case 'blackpink':
            ...
            if (args.length == 0) return dxxoo.reply(from, `Membuat Gambar Text BlackPink\nPemakaian: ${prefix}blackpink [teks]\n\ncontoh: ${prefix}blackpink Dimas`, id)
                await dxxoo.reply(from, `Wait....`, id)
                console.log('Criando Blackpink text...')
    ...
    case 'text3d':
            ...
            if (args.length == 0) return dxxoo.reply(from, `Membuat Gambar Text 3D\nPemakaian: ${prefix}text3d [teks]\n\ncontoh: ${prefix}text3d Dimas`, id)
                await dxxoo.reply(from, `Wait....`, id)
                console.log('Criando text3d text...')
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Text Gambar Hartatahta\nPemakaian: ${prefix}hartatahta [teks]\n\ncontoh: ${prefix}hartatahta Dimas`, id)
                    await dxxoo.reply(from, `Wait....`, id)
                console.log('Criando Hartatahta text...')
	...
	case 'cooltext':
        ...
        case 'stiker':
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                .then(() => {
                    dxxoo.reply(from, 'Aqui est� o seu sticker')
                ...
                if (isMedia || isQuotedImage) {
                    ...
                    console.log(err)
	   	            await dxxoo.reply(from, 'Desculpe, o limite de uso de hoje atingiu o m�ximo', id)
                    }
                }
            } else if (args.length === 1) {
                if (!isUrl(url)) { await dxxoo.reply(from, 'Desculpe, o link que voc� enviou � inv�lido..', id) }
                dxxoo.sendStickerfromUrl(from, url).then((r) => (!r && r !== undefined)
                    ? dxxoo.sendText(from, 'Desculpe, o link que voc� enviou n�o cont�m uma imagem.')
                    : dxxoo.reply(from, 'Aqui esta seu sticker')).then(() => console.log(`Sticker Processed for ${processTime(t, moment())} Second`))
            } else {
            ...
            case 'antisticker':
            case 'antistiker':
                    if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!!', id)
                    if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo', id)
                    if (!isBotGroupAdmins) return dxxoo.reply(from, '� administrador seu gay, torne-me o administrador do grupo primeiro :)', id)
                    if (args[0] == 'on') {
                        var cek = antisticker.includes(chatId);
                        if(cek){
                            return dxxoo.reply(from, '*Detector de adesivos anti-spam * j� est� ativo neste grupo', id) //if number already exists on database
                        } else {
                            antisticker.push(chatId)
                            fs.writeFileSync('./lib/helper/antisticker.json', JSON.stringify(antisticker))
                            dxxoo.reply(from, '*[Anti Sticker SPAM]* foi ativado \ nCada membro do grupo cujo adesivo de spam for maior que 7 ser� chutado pelo bot!!', id)
                        }
                    } else if (args[0] == 'off') {
                        var cek = antilink.includes(chatId);
                        if(cek){
                            return dxxoo.reply(from, '*Anti Spam Sticker Detector* j� est� inativo neste grupo', id) //if number already exists on database
                        } else {
                            let nixx = antisticker.indexOf(chatId)
                            antisticker.splice(nixx, 1)
                            fs.writeFileSync('./lib/helper/antisticker.json', JSON.stringify(antisticker))
                            dxxoo.reply(from, '*[Anti Sticker SPAM]* foi desativado \ n', id)
                        }
                    } else {
                    ...
                    break
                    case 'antilink':
                    if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro do grupo!', id)
                    if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo!!', id)
                    if (!isBotGroupAdmins) return dxxoo.reply(from, '� administrador boiola, torne-me o administrador do grupo primeiro :)', id)
                    if (args[0] == 'on') {
                        var cek = antilink.includes(chatId);
                        if(cek){
                            return dxxoo.reply(from, '*Anti Group Link Detector* j� ativo neste grupo', id) //if number already exists on database
                        } else {
                            antilink.push(chatId)
                            fs.writeFileSync('./lib/helper/antilink.json', JSON.stringify(antilink))
                            dxxoo.reply(from, '*[Anti Group Link]* foi ativado \ nCada membro do grupo que enviar uma mensagem contendo um link de grupo ser� expulso por um bot!', id)
                        }
                    } else if (args[0] == 'off') {
                        var cek = antilink.includes(chatId);
                        if(!cek){
                            return dxxoo.reply(from, '*Anti Group Link Detector* j� est� inativo neste grupo', id) //if number already exists on database
                        } else {
                            let nixx = antilink.indexOf(chatId)
                            antilink.splice(nixx, 1)
                            fs.writeFileSync('./lib/helper/antilink.json', JSON.stringify(antilink))
                            dxxoo.reply(from, '*[Anti Group Link]* foi desativado \ n', id)
                        }
                    } else {
    ...
    if (args.length == 0) return dxxoo.reply(from, `Membuat Sticker Text\nPemakaian: ${prefix}stickertext [teks]\n\ncontoh: ${prefix}stickertext Dimas`, id)
        ...
        case 'stikergif':
            if (isMedia || isQuotedVideo) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    var mediaData = await decryptMedia(message, uaOverride)
                    dxxoo.reply(from, '[WAIT] Em andamento� � aguarde � 1 min!', id)
                    ...
                    await exec(`gify ${filename} ./media/stickergf.gif --fps=30 --scale=240:240`, async function (error, stdout, stderr) {
                        ...
                        .catch(() => {
                            dxxoo.reply(from, 'Desculpe, o arquivo � muito grande!', id)
                        })
                    })
                  } else {
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                .then(() => {
                    dxxoo.reply(from, 'Aqui est� seu sticker')
                    console.log(`Sticker Processed for ${processTime(t, moment())} Second`)
                })
                .catch(() => {
                ...
                await dxxoo.reply(from, 'Desculpe, o adesivo do comando giphy s� pode usar o link do giphy.  [Giphy Only]', id)
            }
            break
      case 'qrread':
    ...
    case 'qrcode':
      ...
      break			
        ...
        case 'quotemaker':
            ...
            if (qmaker.length >= 3) {
                ...
                try {
                    ...
                    dxxoo.reply('Bem, o processo falhou, irm�o, ainda est� correto?..', id)
                }
            } else {
        ...
        case 'nulis':
            ...
            .catch(() => {
                dxxoo.reply(from, 'ha algum Error!', id)
            })
            break
    case 'nulis2':
    ...
    //Education
        case 'wiki':
            ...
            .catch(() => {
                dxxoo.reply(from, 'Oporra, algo est� errado!!', id)
            })
            break
        case 'kbbi':
    ...
    case 'brainly':
            ...
            if (args.length >= 2){
                ...
                dxxoo.sendText(from, 'Feito - ... N�o se esque�a de dizer obrigado')
                        } else {
        ...
        case 'jsolat':
            ...
            .catch(() => {
                dxxoo.reply(from, 'Certifique-se de que sua �rea esteja na lista!', id)
            })
            break
        case 'daerah':
	...
	case 'grouplink':
            ...
            if (isGroupMsg) {
            	...
            	dxxoo.reply(from, 'Este comando s� pode ser usado em grupos!', id)
            }
            break
	case "revoke":
            if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo!', id)
	        if (!isBotGroupAdmins) return dxxoo.reply(from, 'Este comando s� pode ser usado quando o bot se torna administrador', id)
                    if (isBotGroupAdmins) {
                        aruga
		...
		case 'facebook':
			...
			.then(async (res) => {
				...
				if (res.status == 'error') return dxxoo.sendFileFromUrl(from, link, '', 'Desculpe, seu url n�o foi encontrado', id)
				await dxxoo.sendFileFromUrl(from, linkhd, '', 'Aqui est� o v�deo agrade�a', id)
				.catch(async () => {
					await dxxoo.sendFileFromUrl(from, linksd, '', 'Aqui esta o video', id)
					.catch(() => {
						dxxoo.reply(from, 'Desculpe, seu url n�o foi encontrado', id)
					})
				})
			})
			break
        ...
        if (!isGroupMsg) return dxxoo.reply(from, menuId.textPrem(), id)
            ...
            .catch(() => {
                dxxoo.reply(from, 'Hayolohhh, algo deu errado!', id)
            })
            break
      	case 'motivasi':
	...
	case 'dewabatch':
        ...
        dxxoo.reply(from, 'Seja paciente, estou procurando mais ... \ n \ nQuando algo parece errado', id)
        try {
...
if (!isGroupMsg) return dxxoo.reply(from, `Perintah ini hanya bisa di gunakan dalam group!`, id)
        ...
        case 'translate':
            ...
            translate(quoteText, args[0])
                ...
                .catch(() => dxxoo.sendText(from, 'Erro, c�digo de idioma errado..'))
            break
		case 'covidindo':
			rugaapi.covidindo()
			.then(async (res) => {
        ...
        case 'ceklokasi':
            ...
            if (zoneStatus.kode !== 200) dxxoo.sendText(from, 'Desculpe, ocorreu um erro ao verificar o local que voc� enviou..')
            let datax = ''
        ...
        case 'shortlink':
            ...
            if (!isUrl(args[0])) return dxxoo.reply(from, 'Desculpe, o url que voc� enviou � inv�lido..', id)
        ...
        case 'hilihfont':
            ...
            case 'groupinfo' :
            case 'gcinfo' :
                    if (!isGroupMsg) return dxxoo.reply(from, 'Este comando s� pode ser usado em grupos!!', message.id)
...
${desc}\n\nBy : @dimaass.cc`)
        ...
        case 'santet':
                    if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!!', id)
                    if (mentionedJidList.length === 0) return dxxoo.reply(from, 'Tag membro que deseja ser dotado \ n \ nExemplo: #santet @tag |  se voc� defecar, d� descarga', id)
                    if (args.length === 1) return dxxoo.reply(from, 'Digite o motivo de abra��-lo !! \ n \ nExemplo: #santet @tag |  se voc� defecar, d� descarga', id)
        ...
        case 'kutuk':
                    if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!', id)
                    if (mentionedJidList.length === 0) return dxxoo.reply(from, 'Tag membro que deseja ser amaldi�oado \ n \ nExemplo: #cutuk @tag |  se voc� defecar, d� descarga', id)
                    if (args.length === 1) return dxxoo.reply(from, 'Digite o motivo pelo qual ele o estava abra�ando !! \ n \ nExemplo: #cursed @tag |  se voc� defecar, d� descarga', id)
    ...
    case 'dare':
	    ...
	    case 'add':
            if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!', id)
            if (!isGroupAdmins) return dxxoo.reply(from, 'ala membro comum querendo usar poder do admin, este comando s� pode ser usado por administradores de grupo', id)
            if (!isBotGroupAdmins) return dxxoo.reply(from, 'Falha, adicione o bot como administrador do grupo ADM seu gay!', id)
        ...
        case 'kick':
            ...
            if (!isGroupAdmins) return dxxoo.reply(from, 'ala membro comum querendo usar poder do admin, este comando s� pode ser usado por administradores de grupo!', id)
            if (!isBotGroupAdmins) return dxxoo.reply(from, 'Falha, adicione o bot como administrador do grupo ADM seu gay!', id)
            if (mentionedJidList.length === 0) return dxxoo.reply(from, 'Desculpe, o formato da mensagem est� errado. \ NPPor favor, marque uma ou mais pessoas para serem exclu�das', id)
            if (mentionedJidList[0] === botNumber) return await dxxoo.reply(from, 'Desculpe, o formato da mensagem est� incorreto. \ NN�o � poss�vel emitir uma conta de bot sozinho', id)
            await dxxoo.sendTextWithMentions(from, `Request diterima, mengeluarkan:\n${mentionedJidList.map(x => `@${x.replace('@c.us', '')}`).join('\n')}`)
            for (let i = 0; i < mentionedJidList.length; i++) {
                if (groupAdmins.includes(mentionedJidList[i])) return await dxxoo.sendText(from, 'Falha, voc� n�o pode comer a bunda de outro administrador do grupo.')
        ...
        case 'promote':
            ...
            if (mentionedJidList.length !== 1) return dxxoo.reply(from, 'Desculpe, s� pode promover 1 usu�rio', id)
            if (groupAdmins.includes(mentionedJidList[0])) return await dxxoo.reply(from, 'Desculpe, o usu�rio j� � um administrador.', id)
            if (mentionedJidList[0] === botNumber) return await dxxoo.reply(from, 'Desculpe, o formato da mensagem est� errado. \ NN�o � poss�vel promover a conta do bot por si s�', id)
        ...
        case 'bye':
            if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!', id)
            if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo seu merda inferior!', id)
            dxxoo.sendText(from, 'Adeus... ( ⇀‸↼‶ )').then(() => dxxoo.leaveGroup(groupId))
            break
        case 'del':
            if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo seu burro!', id)
		...
		case 'mutegrup':
			if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro de grupos!', id)
            if (!isGroupAdmins) return dxxoo.reply(from, 'Falha, este comando s� pode ser usado por administradores de grupo!', id)
            if (!isBotGroupAdmins) return dxxoo.reply(from, 'Falha, adicione o bot como administrador do grupo! Seu gostoso!', id)
            ...
            if (args[0] == 'on') {
				dxxoo.setGroupToAdminsOnly(groupId, true).then(() => dxxoo.sendText(from, 'Alterado com sucesso para que apenas administradores mitos possam bater papo!'))
			} else if (args[0] == 'off') {
				dxxoo.setGroupToAdminsOnly(groupId, false).then(() => dxxoo.sendText(from, 'Alterado com sucesso para que todos os membros inferiores possam conversar!'))
			} else {
		...
		case 'welcome':
			if (!isGroupMsg) return dxxoo.reply(from, 'Desculpe, este comando s� pode ser usado dentro do grupo!', id)
            if (!isGroupAdmins) return dxxoo.reply(from, 'kkkkkk ala membro comum querendo ser ADM!', id)
            if (!isBotGroupAdmins) return dxxoo.reply(from, 'Falha, adicione o bot como administrador do grupo!', id)
			...
			if (args[0] == 'on') {
				...
				dxxoo.reply(from, 'A mensagem de boas-vindas agora est� habilitada!', id)
			} else if (args[0] == 'off') {
				let xporn = welcome.indexOf(chatId)
				welcome.splice(xporn, 1)
				fs.writeFileSync('./settings/welcome.json', JSON.stringify(welcome))
				dxxoo.reply(from, 'A mensagem de boas-vindas agora est� desativada', id)
			} else {
        ...
        //Owner Bot
        case 'ban':
            if (!isOwnerBot) return dxxoo.reply(from, 'Este comando � apenas para propriet�rios de barcos', id)
        ...
        case 'leaveall': //mengeluarkan bot dari semua group serta menghapus chatnya
            if (!isOwnerBot) return dxxoo.reply(from, 'Este comando � apenas para propriet�rios de BOT', id)
            ...
            dxxoo.reply(from, 'Sucesso deixar todo o grupo!', id)
            break
